...
import { Upload, Download, FileText, Merge, X, ArrowUp, ArrowDown, AlertCircle } from "lucide-react"
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-muted-foreground">Combine multiple PDF files into a single document</p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Add multiple PDF files to merge (max 50MB each)</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Download your merged PDF file</CardDescription>
            </CardHeader>
            <CardContent>
              {mergedFileUrl ? (
                <div className="space-y-6">
                  <div className="text-center p-6 bg-green-50 rounded-lg">
                    ...
                    <p className="text-sm text-green-600 mt-1">{files.length} PDFs merged successfully</p>
                  </div>
                ...
                <div className="text-center py-12 text-muted-foreground">
                  ...
                  <p>Add PDF files and merge them to see results</p>
                </div>
              )}
            </CardContent>
          </Card>
        ...
        <Card className="mt-6">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-medium mb-3">Steps to Merge:</h4>
                <ol className="space-y-2 text-sm text-muted-foreground list-decimal list-inside">
                  <li>Upload multiple PDF files (drag & drop or click to browse)</li>
                  <li>Arrange files in desired order using arrow buttons</li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>• File order determines page order in merged PDF</li>
